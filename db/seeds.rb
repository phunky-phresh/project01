...
s6 = Shape.create :name => 'Flat-Directional', :terrain => 'All-Mountain Powder', :image => 'https://www.burton.com/static/content/2019/images/pdp/snowboarding/diagrams/benddetail-directional-flat-top.svg', :brief => 'A flat profile overall with a rocker nose for the steady stability and effortless float demanded by deep days and surfy terrain.'
